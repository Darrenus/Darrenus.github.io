 ...
 *
 * A career is a chronology. A data workflow is a pipeline. A software design is a layered
 * system. Measured results are a set of numbers. Prose flattens all four into the
 ...
 *
 * Fields carry inline markdown, through the same inline() the prose uses. A row that names a
 * project or school links it, because the reader who wants to open the thing is looking at the
...
/** `2026-02 → 2026-07 | AI 应用开发, 上汽集团 | 内部业务试用` */
 ...
 *
 * Projects and internships can overlap with a degree. A rail that stacks rows in order draws
 * all of those as a sequence, which is a
 ...
 * commas. Both characters also occur inside a link: `[Engine](https://example.com/): x` has a
...
/** `Engine: planner` - the colon separates the layer from what sits in it. */
