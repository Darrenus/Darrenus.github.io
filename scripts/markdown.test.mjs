...
const checks = [
  ...
  },
  {
    ...
    md: "the repo is at https://github.com/example/project today",
    want: (r) =>
      r.hrefs.includes("https://github.com/example/project") &&
      r.text.includes("github.com/example/project"),
  },
  {
  ...
  /* --- structured blocks ------------------------------------------------ */
  {
    ...
    md: "```timeline\n2022-10 → 2024-07 | R&D Intern, Example Co. | Product 1.2.0 to 1.6.0\n2024-07 → 2025-09 | R&D Engineer, Example Co.\n```",
    want: (r) =>
      ...
      r.text.includes("R&D Intern, Example Co.") &&
      r.text.includes("Product 1.2.0 to 1.6.0") &&
      !r.tags.includes("pre"),
  },
  {
  ...
  },
  {
    ...
    md: "```timeline\n2020-09 → 2024-06 | B.Eng., Example University\n2022-10 → 2024-07 | R&D Intern, Example Co.\n2024-07 → 2025-09 | R&D Engineer, Example Co.\n```",
    want: (r) =>
   ...
   * through the same inline() the prose uses, so a name in a box is clickable. */
  {
    ...
    md: "```timeline\n2022-10 → 2024-07 | R&D Intern, [Example Co.](https://example.com/) | shipped [Product](https://example.com/product/)\n2024-07 → 2025-09 | R&D Engineer, [Example Co.](https://example.com/)\n```",
    want: (r) =>
      r.classes.includes("dg dg-gantt") &&
      r.hrefs.includes("https://example.com/") &&
      r.hrefs.includes("https://example.com/product/"),
  },
  {
    name: "the plain rail links too, not only the dated view",
    md: "```timeline\nEarly on | Wrote it at [Example Co.](https://example.com/)\nLater | Led the design\n```",
    want: (r) =>
      r.classes.includes("dg dg-timeline") && r.hrefs.includes("https://example.com/"),
  },
  {
    name: "a flow step links",
    md: "```flow\nsnapshot | scan | [Example OS](https://example.com/) volume\n```",
    want: (r) =>
      r.classes.includes("dg-flow") && r.hrefs.includes("https://example.com/"),
  },
  {
    name: "a stack links both the layer name and its items",
    md: "```stack\n[Daemon](https://example.com/docs/): [service-daemon](https://github.com/example/service-daemon)\n```",
    want: (r) =>
      r.hrefs.includes("https://example.com/docs/") &&
      r.hrefs.includes("https://github.com/example/service-daemon"),
  },
  {
    name: "a metric label links, and the big number stays bare",
    md: "```metrics\n28 | pull requests into [project](https://github.com/example/project)\n```",
    want: (r) =>
      r.hrefs.includes("https://github.com/example/project") &&
      r.text.includes("28"),
  },
  {
    ...
    md: "```timeline\n[2022-10](https://x.test/) → 2024-07 | R&D Intern, Example Co.\n2024-07 → 2025-09 | R&D Engineer, Example Co.\n```",
    want: (r) =>
      r.classes.includes("dg dg-gantt") &&
  ...
  },
  {
    ...
    md: "```stack\nDocs: [guide](https://example.com/a,b), [api](https://example.com/c)\n```",
    want: (r) =>
      r.classes.filter((c) => c === "dg-pill").length === 2 &&
      r.hrefs.includes("https://example.com/a,b"),
  },
  {
